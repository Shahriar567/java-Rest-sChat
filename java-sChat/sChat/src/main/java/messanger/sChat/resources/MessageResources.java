...
public class MessageResources {
	...
	public  List<Message> getAllChatRoom() {
		return messageService.getAllChatRoom();
	}
	...
	public String addChatRoom() {
		return "ChatRoom sucessufully created";
	...
	public String joinChatRoom() {
		return "ChatRoom sucessufully joined";
		
	}
	

	@GET 
	@Path("/getRoom/{messageID}")
	public Message getRoom(@PathParam("messageID") long id) {
		Message message = messageService.getRoomName(id);		
		return message;
